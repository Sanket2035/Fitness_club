...
if (!isset($_GET["id"]) || empty($_GET["id"])) {
    $_SESSION['error_message'] = "No plan specified for editing.";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_err) && empty($description_err) && empty($duration_err) && 
        ...
        $sql = "UPDATE membership_plans 
                SET name = ?, description = ?, duration = ?, price = ?, features = ? 
                WHERE id = ?";
...
<!-- Edit Membership Plan Section -->
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header">
                    <h2 class="mb-0">Edit Membership Plan</h2>
                </div>
                <div class="card-body">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $plan_id); ?>" 
